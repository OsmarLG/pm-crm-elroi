...
export default function CollaborationsInvitationsIndex({ invitations }: Props) {
    ...
    const breadcrumbs = [
        ...
        { title: "Invitations", href: route("collaborations.invitations.index") },
    ]
                                ...
                                <CardContent>
                                    <div className="space-y-4">
                                        <div className="text-sm space-y-1">
                                            <p className="flex justify-between"><span className="font-medium">Role:</span> <span className="capitalize">{invitation.role}</span></p>
                                            <p className="flex justify-between"><span className="font-medium">Sent:</span> {new Date(invitation.created_at).toLocaleDateString()}</p>
                                        </div>
